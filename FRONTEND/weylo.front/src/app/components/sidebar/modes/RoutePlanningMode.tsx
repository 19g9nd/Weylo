    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-shrink-0 p-4 border-t border-gray-200 space-y-2 bg-gray-50">
        <div className="relative group">
          <button
            disabled
            className="w-full py-2.5 px-4 bg-gray-100 text-gray-400 rounded-lg font-medium flex items-center justify-center gap-2 cursor-not-allowed opacity-60"
          >
            <span>📅</span>
            <span>Add day</span>
          </button>
          ...
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
            Full route management available in mobile app
